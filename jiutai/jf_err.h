...
#define JF_ERR_OPTION_ERROR                 (JF_ERR_JIUTAI_ERROR + 0x1D)
...
#define JF_ERR_STRING_ERROR                 (JF_ERR_DYNAMIC_LIB_ERROR + 0x9)
...
#define JF_ERR_REACH_MAX_TRANSACTION        (JF_ERR_GENERIC_ERROR_START + 0x1F)
#define JF_ERR_TRANSACTION_NOT_FOUND        (JF_ERR_GENERIC_ERROR_START + 0x20)
...
#define JF_ERR_FAIL_GET_CWD                 (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x1)
#define JF_ERR_FAIL_SET_CWD                 (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x2)
#define JF_ERR_FAIL_TERMINATE_PROCESS       (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x3)
#define JF_ERR_FAIL_WAIT_PROCESS_TERMINATION (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x4)
#define JF_ERR_FAIL_INIT_SOCKET             (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x5)
#define JF_ERR_FAIL_FINI_SOCKET             (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x6)
...
#define JF_ERR_FAIL_DOWN_SEM                (JF_ERR_SEM_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x2)
#define JF_ERR_FAIL_UP_SEM                  (JF_ERR_SEM_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x3)
...
/* option error */
#define JF_ERR_OPTION_ERROR_START           (JF_ERR_OPTION_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_INVALID_OPTION               (JF_ERR_OPTION_ERROR_START + 0x0)
#define JF_ERR_MISSING_OPTION_ARG           (JF_ERR_OPTION_ERROR_START + 0x1)
...
/* string error */
#define JF_ERR_STRING_ERROR_START           (JF_ERR_STRING_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_INVALID_STRING               (JF_ERR_STRING_ERROR_START + 0x0)
#define JF_ERR_INVALID_SIZE                 (JF_ERR_STRING_ERROR_START + 0x1)
#define JF_ERR_INVALID_MAC_ADDR             (JF_ERR_STRING_ERROR_START + 0x2)
#define JF_ERR_INVALID_DATE                 (JF_ERR_STRING_ERROR_START + 0x3)
#define JF_ERR_INVALID_TIME                 (JF_ERR_STRING_ERROR_START + 0x4)
#define JF_ERR_INVALID_ALIAS                (JF_ERR_STRING_ERROR_START + 0x5)
#define JF_ERR_INVALID_INTEGER              (JF_ERR_STRING_ERROR_START + 0x6)
#define JF_ERR_INVALID_USER_NAME            (JF_ERR_STRING_ERROR_START + 0x7)
#define JF_ERR_INTEGER_OUT_OF_RANGE         (JF_ERR_STRING_ERROR_START + 0x8)
#define JF_ERR_SUBSTRING_NOT_FOUND          (JF_ERR_STRING_ERROR_START + 0x9)
#define JF_ERR_INVALID_FLOAT                (JF_ERR_STRING_ERROR_START + 0xA)

#define JF_ERR_INVALID_SETTING              (JF_ERR_STRING_ERROR_START + 0x50)
#define JF_ERR_SETTING_TOO_LONG             (JF_ERR_STRING_ERROR_START + 0x51)
#define JF_ERR_MISSING_QUOTE                (JF_ERR_STRING_ERROR_START + 0x52)
#define JF_ERR_SETTING_EMPTY                (JF_ERR_STRING_ERROR_START + 0x53)
...
#define JF_ERR_FAIL_RENAME_FILE             (JF_ERR_FILES_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x62)
...
#define JF_ERR_INVALID_JIUKUN_ADDRESS       (JF_ERR_JIUKUN_ERROR_START + 0xB)
...
#define JF_ERR_INVALID_IP                   (JF_ERR_IFMGMT_ERROR_START + 0x1)
#define JF_ERR_INVALID_IP_ADDR_TYPE         (JF_ERR_IFMGMT_ERROR_START + 0x2)
#define JF_ERR_NULL_IP_ADDR                 (JF_ERR_IFMGMT_ERROR_START + 0x3)
#define JF_ERR_INVALID_PORT_NUMBER          (JF_ERR_IFMGMT_ERROR_START + 0x4)
...
#define JF_ERR_UNSUPPORTED_PERSISTENCY_TYPE (JF_ERR_PERSISTENCY_ERROR_START + 0x3)
 ...
 *  @return Void.
 */
LOGGERAPI void LOGGERCALL jf_err_readDescription(u32 u32ErrCode, olchar_t * pstrBuf, olsize_t sBuf);

/** Add description for the vendor specific error code.
 *
 *  @param u32ErrCode [in] The error code to be added.
