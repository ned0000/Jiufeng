...
#define JF_ERR_INVALID_SETTING              (JF_ERR_STRINGPARSE_ERROR_START + 0x50)
#define JF_ERR_SETTING_TOO_LONG             (JF_ERR_STRINGPARSE_ERROR_START + 0x51)
#define JF_ERR_MISSING_QUOTE                (JF_ERR_STRINGPARSE_ERROR_START + 0x52)
#define JF_ERR_SETTING_EMPTY                (JF_ERR_STRINGPARSE_ERROR_START + 0x53)
