...
CGHASHAPI void CGHASHCALL initMd5(md5_t * pMd5);
CGHASHAPI void CGHASHCALL updateMd5(
    md5_t * pMd5, const u8 * pu8Buffer, u32 u32Len);
CGHASHAPI void CGHASHCALL finalMd5(md5_t * pMd5, u8 u8Digest[MD5_DIGEST_LEN]);

/** More convenient function to do md5 digest
 */
CGHASHAPI void CGHASHCALL doMd5(
...
CGHASHAPI void CGHASHCALL initSha1(sha1_t * pSha1);
