...
#define JF_ERR_BASES_ERROR         (JF_ERR_JIUTAI_ERROR + 0x0)
#define JF_ERR_XMALLOC_ERROR       (JF_ERR_JIUTAI_ERROR + 0x1)
#define JF_ERR_ARRAY_ERROR         (JF_ERR_JIUTAI_ERROR + 0x2)
#define JF_ERR_SYNCMUTEX_ERROR     (JF_ERR_JIUTAI_ERROR + 0x3)
#define JF_ERR_RESPOOL_ERROR       (JF_ERR_JIUTAI_ERROR + 0x4)
#define JF_ERR_HASH_ERROR          (JF_ERR_JIUTAI_ERROR + 0x5)
#define JF_ERR_CONFFILE_ERROR      (JF_ERR_JIUTAI_ERROR + 0x6)
#define JF_ERR_HOSTINFO_ERROR      (JF_ERR_JIUTAI_ERROR + 0x7)
#define JF_ERR_MENU_ERROR          (JF_ERR_JIUTAI_ERROR + 0x8)
#define JF_ERR_PROCESS_ERROR       (JF_ERR_JIUTAI_ERROR + 0x9)
#define JF_ERR_CKSUM_ERROR         (JF_ERR_JIUTAI_ERROR + 0xA)
#define JF_ERR_SHAREDMEMORY_ERROR  (JF_ERR_JIUTAI_ERROR + 0xB)
#define JF_ERR_XTIME_ERROR         (JF_ERR_JIUTAI_ERROR + 0xC)
#define JF_ERR_RESOURCE_ERROR      (JF_ERR_JIUTAI_ERROR + 0xD)
#define JF_ERR_SYNCSEM_ERROR       (JF_ERR_JIUTAI_ERROR + 0xE)
#define JF_ERR_DYNLIB_ERROR        (JF_ERR_JIUTAI_ERROR + 0xF)
#define JF_ERR_OBSTACK_ERROR       (JF_ERR_JIUTAI_ERROR + 0x10)
#define JF_ERR_ATTASK_ERROR        (JF_ERR_JIUTAI_ERROR + 0x11)
#define JF_ERR_BITARRAY_ERROR      (JF_ERR_JIUTAI_ERROR + 0x12)
#define JF_ERR_RADIXTREE_ERROR     (JF_ERR_JIUTAI_ERROR + 0x13)
#define JF_ERR_SYNCRWLOCK_ERROR    (JF_ERR_JIUTAI_ERROR + 0x14)
#define JF_ERR_COMMINIT_ERROR      (JF_ERR_JIUTAI_ERROR + 0x15)
...
#define JF_ERR_SMTP_ERROR          (JF_ERR_DYNAMIC_LIB_ERROR + 0x2)
...
#define JF_ERR_NETSEND_ERROR       (JF_ERR_DYNAMIC_LIB_ERROR + 0x6)
#define JF_ERR_CLIENG_ERROR        (JF_ERR_DYNAMIC_LIB_ERROR + 0x7)
#define JF_ERR_EVENT_ERROR         (JF_ERR_DYNAMIC_LIB_ERROR + 0x8)
...
#define JF_ERR_WEBSERVER_ERROR     (JF_ERR_DYNAMIC_LIB_ERROR + 0xF)
#define JF_ERR_SLP_ERROR           (JF_ERR_DYNAMIC_LIB_ERROR + 0x10)
#define JF_ERR_BIGNUM_ERROR        (JF_ERR_DYNAMIC_LIB_ERROR + 0x11)
...
/* bases error */
#define JF_ERR_BASES_ERROR_START (JF_ERR_BASES_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_CREATE_QUEUE (JF_ERR_BASES_ERROR_START + 0x0)
#define JF_ERR_END_OF_HASHTREE (JF_ERR_BASES_ERROR_START + 0x100)
#define JF_ERR_HASHTREE_ENTRY_NOT_FOUND (JF_ERR_BASES_ERROR_START + 0x101)

/* xmalloc error */
#define JF_ERR_XMALLOC_ERROR_START (JF_ERR_XMALLOC_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_OUT_OF_MEMORY (JF_ERR_XMALLOC_ERROR_START + 0x0)
...
/* synmutex error */
#define JF_ERR_SYNCMUTEX_ERROR_START (JF_ERR_SYNCMUTEX_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_CREATE_MUTEX (JF_ERR_SYNCMUTEX_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x0)
#define JF_ERR_FAIL_DESTROY_MUTEX (JF_ERR_SYNCMUTEX_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x1)
#define JF_ERR_FAIL_ACQUIRE_MUTEX (JF_ERR_SYNCMUTEX_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x2)
#define JF_ERR_FAIL_RELEASE_MUTEX (JF_ERR_SYNCMUTEX_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x3)
...
/* hash error */
#define JF_ERR_HASH_ERROR_START (JF_ERR_HASH_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_HASH_ENTRY_NOT_FOUND (JF_ERR_HASH_ERROR_START + 0x0)
...
/* hostinfo error */
#define JF_ERR_HOSTINFO_ERROR_START (JF_ERR_HOSTINFO_ERROR << JF_ERR_CODE_MODULE_SHIFT)

//#define xxx (JF_ERR_HOSTINFO_ERROR_START + 0x0)
...
#define JF_ERR_FAIL_CREATE_PROCESS (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x0)
#define JF_ERR_FAIL_CREATE_THREAD (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x1)
#define JF_ERR_FAIL_STOP_THREAD (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x2)
#define JF_ERR_FAIL_WAIT_THREAD_TERMINATION (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x3)
#define JF_ERR_FAIL_TERMINATE_THREAD (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x4)
#define JF_ERR_FAIL_GET_CWD (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x5)
#define JF_ERR_FAIL_SET_CWD (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x6)
#define JF_ERR_FAIL_TERMINATE_PROCESS (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x7)
#define JF_ERR_FAIL_WAIT_PROCESS_TERMINATION (JF_ERR_PROCESS_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x8)

/* cksum error */
#define JF_ERR_CKSUM_ERROR_START (JF_ERR_CKSUM_ERROR << JF_ERR_CODE_MODULE_SHIFT)

//#define xxx (JF_ERR_CKSUM_ERROR_START + 0x0)
...
/* xtime error */
#define JF_ERR_XTIME_ERROR_START (JF_ERR_XTIME_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_GET_TIME (JF_ERR_XTIME_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x0)

/* resource error */
#define JF_ERR_RESOURCE_ERROR_START (JF_ERR_RESOURCE_ERROR << JF_ERR_CODE_MODULE_SHIFT)

//#define xxx (JF_ERR_RESOURCE_ERROR_START + 0x0)

/* syncsem error */
#define JF_ERR_SYNCSEM_ERROR_START (JF_ERR_SYNCSEM_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_CREATE_SEM (JF_ERR_SYNCSEM_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x0)
#define JF_ERR_FAIL_DESTROY_SEM (JF_ERR_SYNCSEM_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x1)
#define JF_ERR_FAIL_ACQUIRE_SEM (JF_ERR_SYNCSEM_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x2)
#define JF_ERR_FAIL_RELEASE_SEM (JF_ERR_SYNCSEM_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x3)
...
/* obstack error */
#define JF_ERR_OBSTACK_ERROR_START (JF_ERR_OBSTACK_ERROR << JF_ERR_CODE_MODULE_SHIFT)

//#define JF_ERR_OBSTACK_ERROR (JF_ERR_OBSTACK_ERROR_START + 0x0)
...
/* syncrwlock lock */
#define JF_ERR_SYNCRWLOCK_ERROR_START (JF_ERR_SYNCRWLOCK_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_CREATE_RWLOCK (JF_ERR_SYNCRWLOCK_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x0)
#define JF_ERR_FAIL_DESTROY_RWLOCK (JF_ERR_SYNCRWLOCK_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x1)
#define JF_ERR_FAIL_ACQUIRE_RWLOCK (JF_ERR_SYNCRWLOCK_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x2)
#define JF_ERR_FAIL_RELEASE_RWLOCK (JF_ERR_SYNCRWLOCK_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x3)

/* comminit error */
#define JF_ERR_COMMINIT_ERROR_START (JF_ERR_COMMINIT_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_INIT_NET_LIB (JF_ERR_COMMINIT_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x0)
#define JF_ERR_FAIL_FINI_NET_LIB (JF_ERR_COMMINIT_ERROR_START + JF_ERR_CODE_FLAG_SYSTEM + 0x1)
...
/* smtp error */
#define JF_ERR_SMTP_ERROR_START (JF_ERR_SMTP_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_SEND_EMAIL (JF_ERR_SMTP_ERROR_START + 0x0)
#define JF_ERR_EMAIL_SUBJECT_TOO_LONG (JF_ERR_SMTP_ERROR_START + 0x1)
#define JF_ERR_SMTP_NOT_WELCOME (JF_ERR_SMTP_ERROR_START + 0x2)
#define JF_ERR_INVALID_SMTP_MSG (JF_ERR_SMTP_ERROR_START + 0x3)
#define JF_ERR_SMTP_DENY_SENDER (JF_ERR_SMTP_ERROR_START + 0x4)
#define JF_ERR_SMTP_DENY_RECIPIENT (JF_ERR_SMTP_ERROR_START + 0x5)
#define JF_ERR_SMTP_FATAL_ERROR (JF_ERR_SMTP_ERROR_START + 0x6)
#define JF_ERR_INVALID_SMTP_RECIPIENTS (JF_ERR_SMTP_ERROR_START + 0x7)
#define JF_ERR_UNSUPPORTED_SMTP_AUTH_METHOD (JF_ERR_SMTP_ERROR_START + 0x8)
#define JF_ERR_INVALID_SMTP_AUTH_CHALLENGE (JF_ERR_SMTP_ERROR_START + 0x9)
...
/* netsend error */
#define JF_ERR_NETSEND_ERROR_START (JF_ERR_NETSEND_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_SEND_NETSEND_MSG (JF_ERR_NETSEND_ERROR_START + 0x0)
#define JF_ERR_FAIL_QUERY_NETBIOS_NAME (JF_ERR_NETSEND_ERROR_START + 0x1)
...
/* event */
#define JF_ERR_EVENT_ERROR_START (JF_ERR_EVENT_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_EVENT_NOT_FOUND (JF_ERR_EVENT_ERROR_START + 0)
#define JF_ERR_INVALID_EVENT_LOCATION (JF_ERR_EVENT_ERROR_START + 0x1)
#define JF_ERR_EVENT_ID_OUTOFRANGE (JF_ERR_EVENT_ERROR_START + 0x2)
#define JF_ERR_EVENT_EMPTY_STRING (JF_ERR_EVENT_ERROR_START + 0x3)
#define JF_ERR_EVENT_STRLENGTH_TOOLONG (JF_ERR_EVENT_ERROR_START + 0x4)
#define JF_ERR_EVENT_DUPLICATED (JF_ERR_EVENT_ERROR_START + 0x5)
#define JF_ERR_EVENT_TOTAL_EXCEED_MAX (JF_ERR_EVENT_ERROR_START + 0x6)
#define JF_ERR_EVENT_NEW_EVENT (JF_ERR_EVENT_ERROR_START + 0x7)
#define JF_ERR_EVENT_MISSING_EVENT (JF_ERR_EVENT_ERROR_START + 0x8)
#define JF_ERR_EVENT_DUPLICATE_SEVERITY (JF_ERR_EVENT_ERROR_START + 0x9)
#define JF_ERR_EVENT_DUPLICATE_CLASS (JF_ERR_EVENT_ERROR_START + 0xA)
#define JF_ERR_EVENT_DUPLICATE_LOGLOCATION (JF_ERR_EVENT_ERROR_START + 0xB)
#define JF_ERR_EVENT_LINE_BREAK (JF_ERR_EVENT_ERROR_START + 0xC)
...
/* webserver error */
#define JF_ERR_WEBSERVER_ERROR_START (JF_ERR_WEBSERVER_ERROR << JF_ERR_CODE_MODULE_SHIFT)

//#define xxx (JF_ERR_WEBSERVER_ERROR_START + 0x0)

/* slp error */
#define JF_ERR_SLP_ERROR_START (JF_ERR_SLP_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_INVALID_SLP_MSG (JF_ERR_SLP_ERROR_START + 0x0)
#define JF_ERR_SLP_SERVICE_NOT_FOUND (JF_ERR_SLP_ERROR_START + 0x1)
#define JF_ERR_FAIL_SEND_SLP_MSG (JF_ERR_SLP_ERROR_START + 0x2)
#define JF_ERR_SLP_INVALID_SERV (JF_ERR_SLP_ERROR_START + 0x3)
#define JF_ERR_SLP_REACH_MAX_SERV (JF_ERR_SLP_ERROR_START + 0x3)

/* bignum error */
#define JF_ERR_BIGNUM_ERROR_START (JF_ERR_BIGNUM_ERROR << JF_ERR_CODE_MODULE_SHIFT)

#define JF_ERR_FAIL_CREATE_RAND_BIGNUM (JF_ERR_BIGNUM_ERROR_START + 0x0)
...
#define JF_ERR_WAKEUP_SERV_NOT_FOUND (JF_ERR_SERVMGMT_ERROR_START + 0x0)
