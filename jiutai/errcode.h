...
#define OLERR_AETHER_ERROR        (OLERR_DYNAMIC_LIB_ERROR + 0x15)
...
//#define OLERR_ (OLERR_ENCRYPT_ERROR_START + 0x0)

/* encode error */
#define OLERR_ENCODE_ERROR_START (OLERR_ENCODE_ERROR << ERRCODE_MODULE_SHIFT)

//#define xxx (OLERR_ENCODE_ERROR_START + 0)
...
/* aether error*/
#define OLERR_AETHER_ERROR_START (OLERR_AETHER_ERROR << ERRCODE_MODULE_SHIFT)

#define OLERR_FAIL_DESTROY_AETHER_CACHE (OLERR_AETHER_ERROR_START + 0x0)
#define OLERR_FAIL_CREATE_AETHER_CACHE (OLERR_AETHER_ERROR_START + 0x1)
#define OLERR_AETHER_CACHE_GROW_NOT_ALLOW (OLERR_AETHER_ERROR_START + 0x2)
#define OLERR_FAIL_GROW_AETHER_CACHE (OLERR_AETHER_ERROR_START + 0x3)
#define OLERR_UNSUPPORTED_MEMORY_SIZE (OLERR_AETHER_ERROR_START + 0x4)
#define OLERR_FAIL_ALLOC_AETHER_PAGE (OLERR_AETHER_ERROR_START + 0x5)
#define OLERR_INVALID_AETHER_PAGE_ORDER (OLERR_AETHER_ERROR_START + 0x6)
#define OLERR_AETHER_OUT_OF_MEMORY (OLERR_AETHER_ERROR_START + 0x7)
...
#define OLERR_SQL_EXEC_ERROR (OLERR_PERSISTENCY_ERROR_START + 0x0)
