...
} bgad_activity_info_msg_payload;

typedef struct
{
    jf_messaging_header_t baim_jmhHeader;
    bgad_activity_info_msg_payload baim_baimpPayload;
} bgad_activity_info_msg;

typedef struct
{
    u8 basmp_u8Payload[64];
} bgad_activity_status_msg_payload;

typedef struct
{
    jf_messaging_header_t basm_jmhHeader;
    bgad_activity_status_msg_payload basm_basmpPayload;
