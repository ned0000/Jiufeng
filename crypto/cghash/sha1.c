 ...
 *  @file sha1.c
 *
 *  @brief Implementation of the Secure Hashing Algorithm 1
 *
 *  @author Min Zhang
 *
 *  @note
...
static int SHA1Input  (SHA1Context *, const sha1_uint8_t *, u32);
 ...
 *  message.
 */
static int SHA1Input(SHA1Context *context, const sha1_uint8_t *message_array, u32 length)
{
    if (length == 0)
        return shaSuccess;
